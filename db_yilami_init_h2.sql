...
drop table RESOURCES_ROLE ;
drop table ROLE ;
drop table SERVERINFO ;
drop table TEST ;
drop table TEST1 ;
drop table USER ;
drop table USERLOGINLIST ;
drop table USER_COPY_3_0 ;
drop table USER_COPY_3_1 ;
drop table USER_ROLE ;


CREATE TABLE `log` (
  `id` int(11) identity (20150416,1),
  `username` varchar(30),
  `module` varchar(30),
  `action` varchar(30),
...
CREATE TABLE `serverinfo` (
  `id` int(10) identity (20150416,1),
  `cpuUsage` varchar(255),
  `setCpuUsage` varchar(255),
  `jvmUsage` varchar(255),
  `setJvmUsage` varchar(255),
  `ramUsage` varchar(255),
  `setRamUsage` varchar(255),
  `email` varchar(255),
  `operTime` timestamp ,
  `mark` varchar(255),
  PRIMARY KEY (`id`)
...
-- ----------------------------
CREATE TABLE `user` (
  `userId` int(11) identity (20150416,1),
  `userName` varchar(20),
...
CREATE TABLE `userloginlist` (
  `loginId` int(11) identity (20150416,1),
...
-- Records 
-- ----------------------------
INSERT INTO `log` VALUES ('1', 'admin', '资源管理', 'update角色的权限', '117', '10.108.1.58', '2013-12-06 11:15:38.00');
INSERT INTO `log` VALUES ('2', 'admin', '资源管理', 'update角色的权限', '54', '10.108.1.58', '2013-12-06 11:17:40.00');
...
INSERT INTO `serverinfo` VALUES ('1', '9.3', '20', '64.0', '80', '75.0', '80', 'qunlin1108@163.com', '2015-04-14 11:31:04.00', '<font color=\'red\'>内存当前：75.0%,超出预设值  60%</font>');
INSERT INTO `serverinfo` VALUES ('2', '0.8', '20', '60.0', '80', '75.0', '80', 'qunlin1108@163.com', '2015-04-14 11:32:02.00', '<font color=\'red\'>内存当前：75.0%,超出预设值  60%</font>');
INSERT INTO `serverinfo` VALUES ('3', '1.5', '20', '59.0', '80', '75.0', '80', 'qunlin1108@163.com', '2015-04-14 11:33:03.00', '<font color=\'red\'>内存当前：75.0%,超出预设值  60%</font>');
INSERT INTO `serverinfo` VALUES ('4', '0.7', '20', '57.0', '80', '75.0', '80', 'qunlin1108@163.com', '2015-04-14 11:34:02.00', '<font color=\'red\'>内存当前：75.0%,超出预设值  60%</font>');
INSERT INTO `serverinfo` VALUES ('5', '2.3', '20', '57.0', '80', '75.0', '80', 'qunlin1108@163.com', '2015-04-14 11:35:02.00', '<font color=\'red\'>内存当前：75.0%,超出预设值  60%</font>');
INSERT INTO `serverinfo` VALUES ('6', '17.9', '20', '57.0', '80', '77.0', '80', 'qunlin1108@163.com', '2015-04-14 11:36:02.00', '<font color=\'red\'>内存当前：77.0%,超出预设值  60%</font>');
INSERT INTO `user` VALUES ('1', 'admin', 'admin', 'admin', 'admin', '10', '男', '一啦米', '0253526', 'qunlin1108@163.com', '32432', '2015-04-14 10:37:11.00', '0000-00-00 00:00:00.00', '1', null, null, null, null, null, null, null, null, null, null, null, null, null);

INSERT INTO `user` VALUES ('3', '6', '6', '7', '7', '7', '男', '7', '7', '7', '7', '2015-04-14 14:35:43.00', '0000-00-00 00:00:00.00', '1', '7', '7', '7', null, '7', null, '7', '7', '企业账号', '是', '7', '待审核', '');
INSERT INTO `user_role` VALUES ('1', '1');
INSERT INTO `user_role` VALUES ('3', '3');
INSERT INTO `user_role` VALUES ('4', '1');
INSERT INTO `userloginlist` VALUES ('277', '1', '2015-04-14 14:44:18.00', '0:0:0:0:0:0:0:1');
INSERT INTO `userloginlist` VALUES ('278', '1', '2015-04-14 14:50:37.00', '0:0:0:0:0:0:0:1');
INSERT INTO `userloginlist` VALUES ('279', '1', '2015-04-14 14:52:00.00', '0:0:0:0:0:0:0:1');
INSERT INTO `userloginlist` VALUES ('280', '1', '2015-04-14 18:13:07.00', '0:0:0:0:0:0:0:1');
INSERT INTO `userloginlist` VALUES ('281', '1', '2015-04-14 19:40:30.00', '127.0.0.1');
INSERT INTO `userloginlist` VALUES ('282', '1', '2015-04-14 19:43:47.00', '127.0.0.1');
INSERT INTO `userloginlist` VALUES ('283', '1', '2015-04-14 19:44:44.00', '127.0.0.1');
INSERT INTO `userloginlist` VALUES ('284', '1', '2015-04-14 20:36:55.00', '127.0.0.1');
INSERT INTO `userloginlist` VALUES ('285', '1', '2015-04-14 20:46:17.00', '127.0.0.1');
INSERT INTO `userloginlist` VALUES ('286', '1', '2015-04-14 15:33:44.00', '0:0:0:0:0:0:0:1');
INSERT INTO `userloginlist` VALUES ('287', '1', '2015-04-14 16:58:55.00', '0:0:0:0:0:0:0:1');
INSERT INTO `userloginlist` VALUES ('288', '1', '2015-04-14 17:01:13.00', '0:0:0:0:0:0:0:1');
INSERT INTO `userloginlist` VALUES ('289', '1', '2015-04-14 17:04:18.00', '0:0:0:0:0:0:0:1');
INSERT INTO `userloginlist` VALUES ('290', '1', '2015-04-14 17:05:34.00', '0:0:0:0:0:0:0:1');
INSERT INTO `userloginlist` VALUES ('291', '1', '2015-04-14 22:45:45.00', '0:0:0:0:0:0:0:1');
