...
//		System.err.println("-----------MyUserDetailServiceImpl loadUserByUsername ----------- ");
		...
		//取得用户的权限
		com.yilami.entity.User users = userDao.querySingleUser(username);
		if  (users==null)  
	...
	// 取得用户的权限
	private Set<GrantedAuthority> obtionGrantedAuthorities(com.yilami.entity.User user) {
